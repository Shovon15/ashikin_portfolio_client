...
const ExperianceSection = () => {
	...
	return (
		<div className="h-[45rem] md:h-80 bg-gradient-to-r from-blue-300 to-blue-800 p-5 md:px-[5rem] flex flex-col md:flex-row justify-between items-center gap-5 md:gap-10 py-10 ">
