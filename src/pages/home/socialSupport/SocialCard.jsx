...
const SocialCard = ({ data }) => {
  ...
  return (
   ...
   rounded-2xl border-2 border-color-border"
    >
      <div
        className="w-full  h-56 md:h-[340px] mx-auto  bg-transparent 
      ...
      >
        ...
        >
          <div
            className="absolute backface-hidden rounded-2xl  w-full h-full flex flex-col p-2 justify-center items-center "
          >
            <img src={image} className="w-80 md:w-9/12 mx-auto rounded-md" alt="..." />
            <p className="py-2 text-md md:text-xl flex justify-center 
